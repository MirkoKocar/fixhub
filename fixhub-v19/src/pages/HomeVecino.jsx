...
export default function HomeVecino({ user }) {
  ...
  return (
    <div className="page page-enter">
      ...
      {encuesta && (
        <div style={{ padding: '0 20px 16px' }}>
          <div onClick={() => navigate('/encuesta/' + encuesta.id)} style={{ background: 'var(--bg-card)', border: '1px solid rgba(96,165,250,0.18)', borderRadius: 18, padding: '14px 18px', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <p style={{ fontSize: 12, color: 'var(--text-primary)', fontWeight: 700 }}>{encuesta.titulo}</p>
